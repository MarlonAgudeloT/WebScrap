...
#with pd.ExcelWriter('email.xlsx', mode='a') as writer:  
    #df.to_excel(writer, sheet_name='Hoja_1')

"""compression_opts = dict(method='zip',archive_name='email.excel')  
df.to_excel('email.zip', index=False,compression=compression_opts)"""
